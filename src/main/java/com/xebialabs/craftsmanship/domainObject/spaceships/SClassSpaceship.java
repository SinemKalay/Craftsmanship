...
import static com.xebialabs.craftsmanship.helper.ConstantValues.S_CLASS_SPACESHIP;
...
@Entity
@Table(name = "s_class_spaceship")
public class SClassSpaceship extends Spaceship {
    ...
    public SClassSpaceship() {
        super();
        this.setWidth(4);
        this.setHeight(5);
        this.setType(S_CLASS_SPACESHIP);
    }
    ...
    public void build(Coordinate initialCoordinate) {
        ...
        // Row 2
        Coordinate point3 = new Coordinate(initialCoordinate.getRow() + 1, initialCoordinate.getColumn() - 1,NOT_HIT_QUADRANT,this);
        // Row 3
        Coordinate point4 = new Coordinate(initialCoordinate.getRow() + 2, initialCoordinate.getColumn(),NOT_HIT_QUADRANT,this);
        Coordinate point5 = new Coordinate(initialCoordinate.getRow() + 2, initialCoordinate.getColumn() + 1,NOT_HIT_QUADRANT,this);
        //Row 4
        Coordinate point6 = new Coordinate(initialCoordinate.getRow() + 3, initialCoordinate.getColumn() + 2,NOT_HIT_QUADRANT,this);
        // Row 5
        Coordinate point7 = new Coordinate(initialCoordinate.getRow() + 4, initialCoordinate.getColumn(),NOT_HIT_QUADRANT,this);
        Coordinate point8 = new Coordinate(initialCoordinate.getRow() + 4, initialCoordinate.getColumn() + 1,NOT_HIT_QUADRANT,this);
